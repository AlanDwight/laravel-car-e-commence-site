@props(['title' => '', 'bodyClass' => 'page-my-cars', 'cars' => ''])
{{-- {{ dd($cars[1]->maker->name )}} --}}
<x-app-layout title='My Cars' :bodyClass=$bodyClass>
    <main>
        <div>
          <div class="container">
                  ...
                  <tbody>
                    ...
                    @forelse ($cars as $car)
                        ...
                        <tr>
                          ...
                          {{-- first way --}}
                          {{-- <td>{{ $car->created_at ? strtok($car->created_at, ' ') : 'Not created yet'}}</td> --}}
                        ...
                        @empty
                        <tr>
                          <td colspan="5" class="text-center p-large">There is no car yet. You can create your new car entry at <a href="{{route('cars.create')}}">this link.</a></td>
                        </tr>
                    @endforelse
