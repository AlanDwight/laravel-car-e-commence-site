...
<x-app-layout title='Home Page' bodyClass="something" >
    {{-- @php
        $color = "red"; 
        $bgColor = "blue"; 
    @endphp    

    <x-card :color='$color' :bgColor="$bgColor" class="card-layout" test='abc' lang='mm'>
        <x-slot:title class="card-bg-blue" lang='uk'>Card title 1</x-slot:title>
        Card Content 1 
        <x-slot:footer>Card footer 1 </x-slot:footer>
    </x-card>

    <x-inline-component class='card card-bg'>
